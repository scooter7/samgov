...
# SAM.gov API search function with optional parameters
...
# Streamlit UI
st.title("SAM.gov Opportunity Search with Dynamic Filtering")
st.write("Enter search terms to explore SAM.gov opportunities, and test filtering with optional parameters.")
...
if st.button("Search"):
    ...
    if results and "opportunitiesData" in results:
        for i, opportunity in enumerate(results["opportunitiesData"]):
